...
class PatientChargeController extends Controller
{
    public function index(Request $request)
    {
        ...
        //     ->leftJoin('hcharge as type_of_charge', 'pat_charge.chargcode', '=', 'type_of_charge.chrgcode')
    ...
    public function store(Request $request)
    {
        ...
        if ($request->isUpdate == false) {
            ...
            // tanks (oxygen and carbon dioxide)
                ...
                $wardStocks = WardStocksTanks::where(
                    'id',
                    $request->upd_ward_stocks_id
                )->first();
                $previousWardStocks = $wardStocks;
                ...
                if (
                    (int)$previousPatientChargeLogs->quantity != (int)$upd_QtyToReturn
                ) {
                    PatientChargeLogs::create([
                        'enccode' => $previousPatientChargeLogs->enccode,
                        'acctno' => $previousPatientChargeLogs->acctno,
